...
<!--
	...
	function popup(pagina)	{ //Exibe uma janela popUP
		x = window.open(pagina,'Gráfico','dependent=yes,width=1024,height=768,scrollbars=yes,statusbar=no,resizable=no');
		//x.moveTo(10,10);
	...
	function popup_alerta(pagina)	{ //Exibe uma janela popUP
		x = window.open(pagina,'_blank','dependent=yes,width=1024,height=768,scrollbars=yes,statusbar=no,resizable=yes,top='+(window.parent.screenX+50)+',left='+(window.parent.screenY+50)+'');

		return false
	}

	function popup_wide(pagina)	{ //Exibe uma janela popUP
		x = window.open(pagina,'_blank','dependent=yes,width=1024,height=500,scrollbars=yes,statusbar=no,resizable=yes');
	...
	function mini_popup(pagina)	{ //Exibe uma janela popUP
		x = window.open(pagina,'_blank','dependent=yes,width=600,height=450,scrollbars=yes,statusbar=no,resizable=yes');
		//x.moveTo(window.parent.screenX+50, window.parent.screenY+50);
		return false
	}
