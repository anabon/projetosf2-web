...
strAutor = "Leandro Gamito"
  If Err.Number <> 0 Then
    MsgBox "Ocorreu um Erro no Script e ele será terminado, desculpe o transtorno" & vbCrLf & "NUM: " & Err.Number & vbCrLf & "-->" & vbCrLf & Err.Description & vbCrLf & "Entre em contato com o Desenvolvedor do Script:" & strEmail & " - " & strAutor & " e Informe o número do Erro.", 16, "NUM: " & Err.Number & vbCrLf & "-->" & "LINHA: " & Err.Line & vbCrLf
    'wScript.Quit(1)
    Err.Clear
  End If
