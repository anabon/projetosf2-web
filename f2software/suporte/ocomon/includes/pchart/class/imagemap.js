 ...
 function createToolTip(TooltipDivID,Color,Title,Message)
  {
   ...
   var HTML = "<div style='border:1px solid #6177A2'><div style='background-color: #6177A2; font-family: tahoma; font-size: 11px; color: #ffffff; padding: 4px;'><b>"+Title+" &nbsp;</b></div>";
   HTML    += "<div style='background-color: #909090; border-top: 1px solid #606060; font-family: tahoma; font-size: 10px; color: #ffffff; padding: 2px;'>";
