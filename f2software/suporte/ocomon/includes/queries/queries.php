...
$QRY["full_detail_ini"] = "SELECT c.comp_inv as etiqueta, c.comp_sn as serial, c.comp_nome as nome, c.comp_sn_os as sn_os, ".		//LRG
...
$QRY["locais"] = "SELECT l .  * , r.reit_nome, u.login AS usuario, pr.prior_nivel AS prioridade, d.dom_desc AS dominio, pred.pred_desc as predio
		FROM localizacao AS l
		LEFT  JOIN reitorias AS r ON r.reit_cod = l.loc_reitoria
		LEFT  JOIN usuarios AS u ON u.user_id = l.loc_user
		LEFT  JOIN prioridades AS pr ON pr.prior_cod = l.loc_prior
