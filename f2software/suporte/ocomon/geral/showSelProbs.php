<?php /*                        Copyright 2005 Fl�vio Ribeiro
  ...
  */session_start();
    ...
    if(false){     
			print "<option value='-1'>".utf8_encode(TRANS('OCO_SEL_AREA'))."</option>";    
		}else{
        	/*		$query = "
                SELECT * 
                FROM problemas 
