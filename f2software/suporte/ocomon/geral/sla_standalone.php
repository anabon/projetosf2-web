	...
	if (!isset($_POST['ok']) && !isset($_GET['numero'])) { //&& $_POST['ok'] != 'Pesquisar')
		...
		{ //if($linhas==0)
			...
			switch($saida)
			{
				...
				print "<tr bgcolor='".TD_COLOR."' height='25px'>".
					//"<td class='line'><B>".TRANS('OCO_FIELD_NUMBER')."</td>".
					"<td class='line'><b><a title='".utf8_encode(TRANS('HNT_RESPONSE_TIME'))."'>".utf8_encode(TRANS('OCO_RESPONSE'))."</a></td>";
					print "<td class='line'><b><a title='".utf8_encode(TRANS('HNT_SOLUTION_TIME'))."'>".utf8_encode(TRANS('OCO_SOLUC'))."</a></td></B>";
					print "<td class='line'><b><a title='tempo definido para resposta para cada setor'>".utf8_encode(TRANS('COL_TIT_SLA_RESP'))."</a></td></B>
					<td class='line'><b><a title='tempo definido para solução para cada problema'>".utf8_encode(TRANS('COL_TIT_SLA_SOL'))."</a></td></B>
					<td class='line'><b><a title='indicador de resposta'>".utf8_encode(TRANS('COL_TIT_REPLY'))."</a></td></B>
					<td class='line'><b><a title='indicador de solução'>".utf8_encode(TRANS('COL_TIT_SOLUTION'))."</a></td></B>
					<td class='line'><b><a title='indicador de solução a partir da primeira resposta'>".utf8_encode(TRANS('COL_SOL_RESP'))."</a></td></B>
					<td class='line'><b><a title='tempo em que o chamado esteve pendente no usuário'>".utf8_encode(TRANS('COL_USER_DEPEN'))."</a></td></B>
					<td class='line'><b><a title='tempo em que o chamado esteve pendente por algum serviço de terceiros'>".utf8_encode(TRANS('COL_DEPEN_THIRD'))."</a></td></B>
					<td class='line'><b><a title='tempo em equipamento de backup ou alterado após encerramento'>".utf8_encode(TRANS('COL_IT_ARRE_DEPEN'))."</a></td></B>
					<td class='line'><b><a title='Tempo de solução menos o tempo em pendência do usuário'>".utf8_encode(TRANS('COL_RECALC_SOLUTION'))."</a></td></B>
					<td class='line'><b><a title='indicador atualizado descontando a pendência do usuário'>".utf8_encode(TRANS('COL_POINTER_UPDATE'))."</a></td></B>
					<td class='line'><b><a title='".utf8_encode(TRANS('HNT_REMAIN_TIME_IN_SLA'))."'>".utf8_encode(TRANS('COL_REMAIN_TIME'))."</a></td></B>
					</tr>";
...
// 							$row_openStat = mysql_fetch_array($exec_upd);
					...
					print "<tr style=\"height: 30px;\" id='linha".$cont."'  onMouseDown=\"marca('linha".$cont."', '".$_SESSION['s_colorMarca']."');\">";
