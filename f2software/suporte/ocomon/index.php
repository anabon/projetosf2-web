...
//print "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Frameset//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-frameset.dtd\">";
	...
	*/
	...
	if (is_file("./".$iconPath."icone.png")) {
		print "<link rel='shortcut icon' href='./".$iconPath."icone.ico'>";
	}
...
print "<title>Suporte F2 Software</title>";
//print "<meta http-equiv='Content-Type' content='text/html; charset=utf-8'>";

print "<link rel='stylesheet' href='includes/css/estilos.css.php'>"; //type='text/css'
print "<link rel='stylesheet' href='includes/css/style.css'>"; //altera o estilo do sistema
           ...
           print "<div id='menuwrapper'>
                    ...
                    <li class='barra_li'><a class='trigger' href='#'><img src='".$iconPath."gohome.png' />  ".TRANS('MNS_HOME')."</a>
                        <ul>
                            ...
                            <li><a target='centro' href='".$ocoDirPath."contatos_locais.php'><img src='".$iconPath."search.png'/>  ".TRANS('MNL_INFORMACOES')."</a></li>
	...
	//Formulï¿½rio de Login
		...
		print "<form name='logar' method='post' action='".$commonPath."login.php?".session_id()."' onSubmit=\"return valida()\">";
                ...
                <div class='div_login'>";
                        ...
                        print "<div style='margin:0 auto; width:500px; height:100px; padding:40px 0 0 60px;'>
                                    <div id='login_titulo'>Painel de Login</div>
                                    <div id='login_user'>
									
                                   <span class='login_label'><label  id='label_user' class='input_login' for='idLogin' style='display:block;'>".TRANS('MNS_USUARIO')."</label></span>
								   <span class='login_text'><input class='input_l2' type='text' name='login' autocomplete='off' value='".$typedUser."' id='idLogin3' tabindex='1' \"></span>".
                                   " 
                                    </div>
                                   ...
                                   <span class='login_label'><label  id='label_pass' class='input_login' for='idSenha' style='display:block;'>".TRANS('MNS_SENHA')."</label></span>
								   <span class='login_text'><input class='input_l2' type='password'  name='password'  id='idSenha3' tabindex='2' \"></span>".
                                   " 
								   </div>
                            ...
                            // print "<center  id='login_cad_abetura'><br>".TRANS('MNS_MSG_CAD_ABERTURA_1')."<a href='' onClick=\"mini_popup('./".$ocoDirPath."newUser.php')\"><b><u><font color='#FF0000'>".TRANS('MNS_MSG_CAD_ABERTURA_2')."!</font></u></b></a></center>";
        ...
        print "<tr><td>";
        print "<div style='position:relative;width:100%;bottom:0px;height:60px; font-size:12px';>
            <center style='margin:8px;'><p>F2 Software Solução Tecnologicas</div>";
        print "</td></tr>";
...
var GLArray = new Array();
	...
	function valida(){
		...
		var ok = validaForm('idLogin2','ALFAFULL','Usuário',1)
		if (ok) var ok = validaForm('idSenha2','ALFAFULL','Senha',1);
