<?php session_start();
  ...
  */
	...
	$resultado = mysql_query($query) or die (TRANS('ERR_QUERY').$query);
        ...
        if ($linhas>1)
                print "<TR><TD  class='line' bgcolor='".$cor1."'><B>".TRANS('THEREARE','Existem')."&nbsp;".$linhas."&nbsp;".TRANS('OCO_HIDDEN_NOTICE','avisos não exibidos nessa tela!  Verifique no mural').".</B></TD></TR><BR>";
	...
	if ($linhas == 0) {
		...
		if ($linhas>=1) {
			...
			print "<tr><TD><IMG ID='imgAgendados' SRC='../../includes/icons/".$_SESSION['ICON_CHAVE2']."' width='12' height='12' ".
		...
		print "<TABLE class='header_centro' STYLE='{border-top: thin solid #999999;}' border='0' cellpadding='2' cellspacing='0' align='center' width='100%'>";
		print "<TR class='header'>";
			print "<TD    WIDTH='75' class='line' >".TRANS('OCO_NUMBER_BRIEF')."</TD>".
                                "<TD  WIDTH='50' class='line' >".TRANS('col_etiqueta')."</TD>".
                                "<TD class='line' WIDTH='120'>".TRANS('MNS_OPERADOR')."</TD>".
                                "<TD  WIDTH='100' class='line' >".TRANS('OCO_PROB')."</TD>".
				"<TD  WIDTH='120' class='line' >".TRANS('OCO_CONTACT')."<BR>".TRANS('OCO_PHONE')."</TD>".
				"<TD  class='line' WIDTH='100'>".TRANS('OCO_LOCAL')."<BR>".  TRANS('OCO_DESC')."</TD>".
				"<TD  WIDTH='160' class='line' >".TRANS('OCO_STATUS')."</TD>".
        "<TD  WIDTH='120' class='line' >".TRANS('col_data')."</TD>".
				"<TD  class='line' WIDTH='80' valign='right'><a title='".TRANS('HNT_REMAIN_TIME')."'>".TRANS('OCO_REMAIN_TIME')."</a></TD>";
		print "</TR>";
        }
        $i=0;
        $j=2;
		...
		print "<TD  class='line'  ".$valign."><a href='mostra_consulta.php?numero=".$rowAT['numero']."'><img src='../../includes/icons/agendado.png'></img>".$rowAT['numero']."</a>".$imgSub."</TD>";
		print "<TD  class='line'  ".$valign.">".$rowAT['etiqueta']."</TD>";
    print "<TD  class='line'  ".$valign.">".$rowAT['nome']."</TD>";
		print "<TD  class='line'  ".$valign.">".$linkImg."&nbsp;".nl2br($rowAT['problema'])."</TD>";
		...
		if (strlen($texto)>200){
	        ...
	        print "</TD>";
              ...
              print "<TD  class='line'  ".$valign.">".$rowAT['data_abertura']."</TD>";
	...
	//query alterada para monstrar todos os tecnicos em atendimento
    ...
    //buscar todas ocorrencias em atendimento que não sejam agendamento	
	$query = $QRY["ocorrencias_full_ini"]." WHERE s.stat_painel in (1) and o.oco_scheduled=0 ORDER BY numero";
	$resultado_oco = mysql_query($query) or die (TRANS('ERR_QUERY').$query);
        $linhas = mysql_num_rows($resultado_oco);
...
// 				"".TRANS('OCO_PENDING')."</font>&nbsp;".TRANS('OCO_TO_USER','para o usuário')."&nbsp;".$_SESSION['s_usuario'].".</b></td></tr>";
 			...
 			print "<tr><TD><IMG ID='imgVinculados' SRC='../../includes/icons/".$_SESSION['ICON_CHAVE']."' width='12' height='12' ".
		...
		print "<TR class='header'>";
			print "<TD  class='line' WIDTH='50'>".TRANS('OCO_NUMBER_BRIEF')."</TD>".
				"<TD class='line' WIDTH='50'>".TRANS('col_etiqueta')."</TD>".
				"<TD class='line' WIDTH='80'>".TRANS('MNS_OPERADOR')."</TD>".
        "<TD class='line' WIDTH='100'>".TRANS('OCO_PROB','Problema')."</TD>".
				"<TD class='line' WIDTH='80'>".TRANS('OCO_CONTACT')."<BR>".TRANS('OCO_PHONE','Ramal')."</TD>".
				"<TD class='line'  WIDTH='250'>".TRANS('OCO_LOCAL')."<br>".TRANS('OCO_DESC')."</TD>".
				"<TD class='line' WIDTH='120'>".TRANS('OCO_STATUS')."</TD>".
				"<TD class='line' WIDTH='30'><a title='".TRANS('HNT_VALID_TIME')."'>".TRANS('OCO_VALID_TIME')."</a></TD>".
				"<TD class='line' WIDTH='20'><a title='".TRANS('HNT_RESPONSE_TIME')."'>".TRANS('OCO_RESPONSE')."</a></TD>".
				"<TD class='line' WIDTH='20'><a title='".TRANS('HNT_SOLUTION_TIME')."'>".TRANS('OCO_SOLUC','SOLUC.')."</a></TD>";
		print "</TR>";
        }
        $i=0;
        $j=2;
		...
		print "<TD  class='line'  ".$valign."><a href='mostra_consulta.php?numero=".$rowAT['numero']."'><img src='../../includes/icons/em_atendimento.png'></img>".$rowAT['numero']."</a>".$imgSub."</TD>";
		print "<TD  class='line'  ".$valign.">".$rowAT['etiqueta']."</TD>";
		print "<TD  class='line'  ".$valign.">".$rowAT['nome']."</TD>";
		print "<TD  class='line'  ".$valign.">".$linkImg."&nbsp;".nl2br($rowAT['problema'])."</TD>";
		print "<TD  class='line'  ".$valign."><b>".$rowAT['contato']."</b><br>".$rowAT['telefone']."</TD>";
...
// 	$PAGE->execSQL();
	...
	//FILA DE CHAMADOS
        print "  <TR class='header'>";
        print "  <TD  WIDTH='50'  class='line'  nowrap>".TRANS('OCO_NUMBER_BRIEF','N.º')."&nbsp;/&nbsp;<a STYLE=\"cursor: pointer;\" onClick=\"redirect('".$_SERVER['PHP_SELF']."?&ORDERBY=AREA')\" title='Ordena por Área de atendimento'>".TRANS('OCO_AREA','Área')."".$ICON_ORDER_AREA."</a></TD>".
		"<TD  WIDTH='50'  class='line' >".TRANS('col_etiqueta')."</TD>".
        	"<TD  WIDTH='50' class='line' ><a STYLE=\"cursor: pointer;\" onClick=\"redirect('".$_SERVER['PHP_SELF']."?&ORDERBY=PROB')\" title='Ordena por tipo de problema'>".TRANS('OCO_PROB')."".$ICON_ORDER_PROB."</a></TD>".
        	"<TD  WIDTH='80' class='line' ><a STYLE=\"cursor: pointer;\" onClick=\"redirect('".$_SERVER['PHP_SELF']."?&ORDERBY=CONTATO')\" title='Ordena pelo contato'>".TRANS('OCO_CONTACT')."".$ICON_ORDER_CONTATO."</a><BR>".TRANS('OCO_PHONE','Ramal')."</TD>".
        	"<TD  WIDTH='250'class='line' ><a STYLE=\"cursor: pointer;\" onClick=\"redirect('".$_SERVER['PHP_SELF']."?&ORDERBY=LOCAL')\" title='Ordena por Localização'>".TRANS('OCO_LOCAL')."".$ICON_ORDER_LOCAL."</a><br>".TRANS('OCO_DESC')."</TD>".
        	"<TD  WIDTH='30' class='line' nowrap><a STYLE=\"cursor: pointer;\" onClick=\"redirect('".$_SERVER['PHP_SELF']."?&ORDERBY=DATA')\" title='Order by ".TRANS('HNT_VALID_TIME')."'>".TRANS('OCO_VALID_TIME')."".$ICON_ORDER_DATA."</a></TD>".
        	...
        	"<TD  class='line'  WIDTH='20'><a STYLE=\"cursor: pointer;\" onClick=\"redirect('".$_SERVER['PHP_SELF']."?&ORDERBY=PRIOR')\" title='Ordena por ".TRANS('HNT_PRIORITY')."'>".TRANS('P')."".$ICON_ORDER_PRIOR."</a></TD>".
        	"<TD  class='line'  WIDTH='20'><a title='".TRANS('HNT_RESPONSE_TIME')."'>".TRANS('OCO_RESPONSE')."</a></TD>".
        	"<TD  class='line'  WIDTH='20'><a title='".TRANS('HNT_SOLUTION_TIME')."'>".TRANS('OCO_SOLUC')."</a></TD>";
        print "</TR>";
        $i=0;
        $j=2;
		...
		print "<TD  class='line'  ".$valign."><b><a href='mostra_consulta.php?numero=".$row['numero']."'><img src='../../includes/icons/log-out.png'>".$row['numero']."</img></a></b>".$imgSub."<br>".($row['area']==''?'&nbsp;':$row['area'])."</td>";
		print "<TD  class='line'  ".$valign.">".$row['etiqueta']."</TD> ";
...
// 		print "</TD>";
        ...
        //Copia do HOME para mostrar os chamados as área... LRG

        print "<br><br>
            <TABLE border='0' cellpadding='0' cellspacing='0' align='center' width='100%' bgcolor='".$cor3."'>";
	...
	$regTotal = mysql_num_rows($execTotal);
            	...
            	print "<tr><td colspan='7'><b><a href='../../home.php' style='color:#000'>".TRANS('THEREARE')." <font color='red'>".$regTotal."</font>".
			" ".TRANS('HOME_OPENED_CALLS').".</b></a></td></tr>";
