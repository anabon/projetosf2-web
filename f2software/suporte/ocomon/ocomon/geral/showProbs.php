	...
	$auth->testa_user_hidden($_SESSION['s_usuario'],$_SESSION['s_nivel'],$_SESSION['s_nivel_desc'],4);
			...
			print "<TABLE border='0' cellpadding='2' cellspacing='0' width='90%'>";
				...
				else
				{
					...
					print "<TR class='header'><td class='line'>".utf8_encode(TRANS('COL_PROB','Problema'))."<td class='line'>".utf8_encode(TRANS('COL_SLA','SLA'))."</TD>". //<td class='line'>".TRANS('COL_AREA','')."</TD>
						"<td class='line'>".utf8_encode($row_config['conf_prob_tipo_1'])."</TD><td class='line'>".utf8_encode($row_config['conf_prob_tipo_2'])."</TD>".
						"<td class='line'>".utf8_encode($row_config['conf_prob_tipo_3'])."</TD></tr>";
					...
					while ($row = mysql_fetch_array($resultado))
					{
						...
						//------------------------------------------------------------- FIM ALTERACAO --------------------------------------------------------------
						print ">".utf8_encode($row['problema'])."</td>";
