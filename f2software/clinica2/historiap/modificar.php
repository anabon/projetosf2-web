...
<div class="body4">
 ...
 //no se
  ...
  $link=conectarse() ;
   ...
   echo "<ul>";
echo "<li ><a target='_blank' href=expedientepdf.php?codigo=".$x1.">EXPEDIENTE COMPLETO</a></li>";
echo "<li ><a  href=eliminar.php?codigo=".$x1.">ELIMINAR</a></li>";
echo "<li class='bg_none' ><a  href=actualizar.php?codigo=".$x1.">EDITAR</a></li>";
			?>
...
<div class="body4">
 ...
 //no se
  ...
  $link=conectarse() ;
   ...
   echo "<ul>";
   echo   "<li><a href=nuevaconsul.php?codigo=".$x1.">NUEVA CONSULTA</a></li>";
   echo   "<li><a href=evoluciones.php?codigo=".$x1.">EVOLUCIONES</a></li>";
  echo   "<li class='bg_none'><a target='_blank' href=pacientecpdf.php?codigo=".$x1.">IMPRIMIR EXPEDIENTE</a></li>";
