...
<div class="body3">
	...
	<section id="content">
		<div class="wrapper pad_bot1">
			...
			<center>		
				<form id= 'formulario' action= 'procesa.php' method= 'post'>

   <table>
   <tr>
   <td>
   <label for="cedula"> CEDULA	 :</label>
   <input type="text" id="cedula" name='cedula' placeholder='usuario...'>
   </td>
   </tr>
   <tr>
   <td>
   ...
   <tr>
   <td>
     <label for="pass"> PASSWORD :   <input type="text"id="pass"  name='pass' placeholder='password...'></label>
   </td>
   </tr>
 <tr>
 <td>
 
	 <input name= 'enviar' type= 'submit' value= 'Guardar'></label>
</td>
</tr>
</table>
		</form>	
