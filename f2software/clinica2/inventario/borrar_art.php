			...
			<div class="wrapper">
				<nav>
					...
					<div class="text1"></span></div>
						...
						<li ><a href="../historiap.php">Historias Pediatricas </a></li>
...
<form action="borrar_art.php" method="post" name="form">
   		...
   		<? echo'<select input type="text" name="descriccion"> '.$options_prd.'</select>'; ?>
...
$reg=mysql_query("SELECT codigo FROM productos WHERE  descriccion='$_POST[descriccion]' ",$con);
...
{
	mysql_query("DELETE FROM productos WHERE descriccion='$_POST[descriccion]'",$con);
