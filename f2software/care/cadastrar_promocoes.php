...
$servidor = "localhost"; 
 ...
 <nav class="nav-bar" style="background: rgba(0,0,0,0.5); height: 150px;">
    <div class="nav-container"> 
        ...
        <ul class="nav-list " id="nav">
          <ion-icon name="contact"></ion-icon>
            ...
            <li> <a href="#" id="tile7"><i class="icon ion-cash"></i>Manutenção de Perfil</a></li>
    ...
    <div class = "row" style="width: 1020">
        ...
        <a class = "btn dropdown-button" href = "#" data-activates = "dropdown">Cadastrar Promoções
         <i class = "mdi-navigation-arrow-drop-down right"></i></a>
       </div>

         <form method="POST" action="cadastro_promocoes.php">
...
<?php
    ...
    or die(mysql_error());
?>                                        
        <select name="servico" id="form-field-1" class="col-xs-11 col-sm-6 col-md-8">
        <option value="" selected disabled="disabled" hidden>Escolha o serviço</option>
      ...
      <option value="<?php echo $dados['id_servico']; ?>"><?php echo $dados['descricao_servico']; ?></option> <?php } ?>
         ...
         <!---------------FIM  SERVIÇO------------------------>
            <div class = "row">
                ...
                <label style="font-size: 20px">Data Inicio</label> <br/>
                  <input placeholder = "Digite a data do incio da promoção" name="data_inicio" id = "data_final"
                     type = "text" class = "active validate" required />
                   </div>
                
                <div class = "input-field col s6">
                <label style="font-size: 20px">Data Final</label> <br/>
                  <input placeholder = "Digite a Data Final da promoção" name="data_final"  id = "data_final"
                     type = "text" class = "active validate" required />
              ...
              <div class = "row">
                   <div class = "input-field col s6">
                <label style="font-size: 20px">R$ Promocional</label> <br/>
                  <input placeholder = "Digite o valor promocioonal" name="valor_promocional" id = "valor_promocional"
                     type = "text" class = "active validate" required />
                   </div>
                
                <div class = "input-field col s6">
                <label style="font-size: 20px">Nome Promoção</label> <br/>
                  <input placeholder = "De um nome de destaque a sua promoção" name="nome_promocao"  id = "nome_promocao"
                     type = "text" class = "active validate" required />
