 ...
 <nav class="nav-bar" style="background: rgba(0,0,0,0.5); height: 150px;">
    <div class="nav-container"> 
      ...
      <div class = "row" style="width: 1020">
        ...
        <a class = "btn dropdown-button" href = "#" data-activates = "dropdown">Clientes
         <i class = "mdi-navigation-arrow-drop-down right"></i></a>
          ...
          <div class = "row" style="background: #fff; margin-top: 5%; font-family: arial ">
           <div class="container" style="background: #ffff">
            <div class="input-fild col s6 h3">
          
           <a href="aniversariante_mes.php"><img src="img/aniversariantes.png"></a>
           <h3>Anivérsáriantes</h3>
           
              </div>

              
                  <div class="input-fild col s6 h3">
                     <img src="img/cliente_3.png">
                     <h3>Historico</h3>
