...
if (isset($_GET['txtbusca'])) {
  $fornecedor_rs_forn = $_GET['txtbusca'];
}
mysql_select_db($database_dbsite, $dbsite);
$query_rs_forn = sprintf("SELECT t1.forn_id, t1.forn_nome, t1.forn_fone1, t1.forn_fone2, t1.forn_sit FROM tb_forn AS t1 WHERE t1.forn_nome LIKE %s AND t1.forn_sitreg = 1 ORDER BY t1.forn_nome ASC", GetSQLValueString("%" . $fornecedor_rs_forn . "%", "text"));
...
<table width="100%" border="0" cellspacing="10" cellpadding="5" style="border-bottom:#666 2px solid;">
  <tr>
    <td class="body_titulo2">PEESQUISA POR FORNECEDORES</td>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
      <tr>
        ...
        <td bgcolor="#cccccc" class="registro_titulo-col">Nome</td>
        <td width="100" bgcolor="#cccccc" class="registro_titulo-col">Telefone 1:</td>
        <td width="100" bgcolor="#cccccc" class="registro_titulo-col">Telefone 2:</td>
  ...
  <?php do { ?>
    <table width="100%" border="0" cellspacing="0" cellpadding="2" style="border-bottom:#CCC 1px dotted;" onMouseOver="bgColor='#EFEFEF'" onMouseOut="bgColor='#FFFFFF'">
      <tr>
        ...
        <td width="100" align="center"><?php echo $row_rs_forn['forn_sit']; ?></td>
        <td width="200"><table border="0" align="right" cellpadding="4" cellspacing="0">
          <tr>
            ...
            <td width="50"><form id="frmbt_del" name="frmbt_del" method="get" action="painel.php">
              <input name="pg" type="hidden" id="pg" value="forndel" />
...
<?php if ($totalRows_rs_forn == 0) { // Show if recordset empty ?>
  <table width="100%" border="0" cellspacing="0" cellpadding="10">
    <tr>
      <td class="sem_permissao">Nenhum resultado.</td>
    </tr>
  </table>
