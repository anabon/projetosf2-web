...
mysql_select_db($database_dbsite, $dbsite);
$query_rs_auto = "SELECT t1.auto_id, t1.auto_img, t1.auto_placa, t1.auto_nome, t1.auto_modelo, t2.comb_nome, t1.auto_vlrvenda, t1.auto_vlrfipe, t1.auto_sit FROM tb_auto AS t1 LEFT JOIN tb_comb AS t2 ON t2.comb_id = t1.auto_comb WHERE t1.auto_sitreg = 1 ORDER BY t1.auto_dtcad DESC";
...
<table width="100%" border="0" cellspacing="10" cellpadding="5" style="border-bottom:#666 2px solid;">
  <tr>
    <td class="body_titulo2">VEH&Iacute;CULO</td>
...
<?php /*START_PHP_SIRFCIT*/ if ($row_rs_perm_usr['perfil_auto']!="S"){ ?>
    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
          ...
          <td width="80" bgcolor="#cccccc" class="registro_titulo-col">Chapa</td>
          <td bgcolor="#cccccc" class="registro_titulo-col">Modelo</td>
          <td width="100" align="center" bgcolor="#cccccc" class="registro_titulo-col">Valor USD</td>
