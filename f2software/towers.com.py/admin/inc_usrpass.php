...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "frmEdit")) {
  $updateSQL = sprintf("UPDATE tb_usr SET usr_senha=%s WHERE usr_id=%s",
                       GetSQLValueString($_POST['usr_senha'], "text"),
...
<table width="100%" border="0" cellspacing="10" cellpadding="5" style="border-bottom:#666 2px solid;">
  <tr>
    <td class="body_titulo2">Cambio de contrase;&Atildea;a</td>
=
      ...
      <td><form id="frmEdit" name="frmEdit" method="POST" action="<?php echo $editFormAction; ?>">
        <table width="600" border="0" cellspacing="0" cellpadding="5">
          <tr>
            ...
            <span class="passwordRequiredMsg">Introduzca su nueva contrasena!</span><span class="passwordMinCharsMsg">Por lo menos 5.</span><span class="passwordMaxCharsMsg"></span></span></td>
          </tr>
          <tr>
            <td>Repetición:</td>
            <td><span id="spryconfirm1">
              <input name="usr_senha2" type="password" class="frmCad_150" id="usr_senha2" maxlength="30" />
              <span class="confirmRequiredMsg">Repita su nueva contrasena.</span><span class="confirmInvalidMsg">Contrasena diferente!</span></span></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td align="left"><input type="submit" value="Alterar senha" /></td>
          </tr>
        </table>
