...
mysql_select_db($database_dbsite, $dbsite);
$query_rs_bancos = "SELECT t1.banco_id, t1.banco_cod, t1.banco_banco, t1.banco_url, t1.banco_sit FROM tb_banco AS t1 ORDER BY t1.banco_sit ASC, t1.banco_banco ASC";
...
<table width="100%" border="0" cellspacing="10" cellpadding="5" style="border-bottom:#666 2px solid;">
  <tr>
    <td class="body_titulo2">BANCOS</td>
