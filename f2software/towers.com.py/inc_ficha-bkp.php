...
?>
  ...
  <table width="700" cellpadding="5" cellspacing="0">
    ...
    <tr>
      <td class="KT_th"><strong>
        <label for="ficha_rgemissor">Órgão Emissor:</label>
        </strong></td>
    ...
    <tr>
      ...
      <td><select name="ficha_escolaridade" id="ficha_escolaridade">
        ...
        <option value="Medio" <?php if (!(strcmp("Medio", KT_escapeAttribute($row_rstb_ficha['ficha_escolaridade'])))) {echo "SELECTED";} ?>>Médio</option>
        ...
        <option value="Pos graduado" <?php if (!(strcmp("Pos graduado", KT_escapeAttribute($row_rstb_ficha['ficha_escolaridade'])))) {echo "SELECTED";} ?>>Pós graduado</option>
    ...
    <tr>
      <td class="KT_th"><strong>
        <label for="ficha_mae">Nome da Mãe:</label>
        </strong></td>
    ...
    <tr>
      <td class="KT_th"><label for="ficha_conjempcargo">Cargo ou função:</label></td>
    ...
    <tr>
      <td class="KT_th"><label for="ficha_endcorreio">Endereço p/<br />
        correspondência:</label></td>
      <td><select name="ficha_endcorreio" id="ficha_endcorreio">
        <option value="Residencial" <?php if (!(strcmp("Residencial", KT_escapeAttribute($row_rstb_ficha['ficha_endcorreio'])))) {echo "SELECTED";} ?>>Residêncial</option>
    ...
    <tr>
      <td class="KT_th"><label for="ficha_endtempo">Tempo de residência:</label></td>
    ...
    <tr>
      <td class="KT_th"><label for="ficha_endtipo">Tipo de residência:</label></td>
    ...
    <tr>
      <td class="KT_th"><label for="ficha_profcargo">Cargo / Função:</label></td>
    ...
    <tr>
      <td class="KT_th"><label for="ficha_profdtadmissao">Data de admissão:</label></td>
    ...
    <tr>
      <td class="KT_th"><label for="ficha_profrendaconj">Renda do cônjugue (opcional):</label></td>
    ...
    <tr>
      <td class="KT_th"><label for="ficha_bancoagencia">Agência:</label></td>
    ...
    <tr>
      <td class="KT_th"><label for="ficha_bancofone1">Telefone da agência:</label></td>
    ...
    <tr>
      <td colspan="2" class="KT_th"><label for="ficha_bemimovel">Possui imóveis? Se sim, descreva-o(s). Ex.: casa, apartamento, sítio, etc...</label></td>
      </tr>
    <tr>
    ...
    <tr>
      <td colspan="2" class="KT_th"><label for="ficha_bemimovelvalor">Qual o valor total atual do(s) imóvel(is)?</label></td>
      </tr>
    <tr>
    ...
    <tr>
      <td colspan="2" class="KT_th"><label for="ficha_bemauto">Possui veículos? Se sim, descreva-o(s). Ex.: VW Parati 1.6 2002.</label></td>
      </tr>
    <tr>
    ...
    <tr>
      <td colspan="2" class="KT_th"><label for="ficha_bemautovalor">Qual o valor total atual do(s) veículo(s)?</label></td>
      </tr>
    <tr class="KT_buttons">
